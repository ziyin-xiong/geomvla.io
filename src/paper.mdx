...
GeomVLA unifies what the robot sees, how the scene may move, and how the robot should act in one shared 3D space. It lifts vision-language features into 3D, predicts task-conditioned scene motion as latent geometric guidance, and generates actions through a 3D-aware denoising policy. Across simulation and real-world manipulation tasks, this geometric consistency leads to stronger and more reliable performance than 2D or motion-only VLA baselines.
